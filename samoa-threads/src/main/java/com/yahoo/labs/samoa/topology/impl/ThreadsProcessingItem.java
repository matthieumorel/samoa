...
public class ThreadsProcessingItem extends AbstractProcessingItem {
    ...
    /*
     * Setup the replicas of this PI. This should be called after the topology
     * is set up (all Processors and PIs are setup and connected to the
     * respective streams) and before events are sent.
     */
