...
public class RandomRBFGeneratorEvents extends ClusteringStream {
    ...
    private class GeneratorCluster implements Serializable {
        ...
        private void updateKernel() {
            ...
            // we could be lot more precise if we would keep track of timestamps
            // of points
            // then we could remove all old points and rebuild the cluster on up
            // to date point base
        ...
        private String splitKernel() {
            ...
            if (spcluster != null) {
                ...
                System.out
                        .println("Tried to split new kernel from C"
                                + generator.getId()
                                +
    ...
    /*************** EVENT Listener *********************/
    // should go into the superclass of the generator, create new one for
    // cluster streams?
