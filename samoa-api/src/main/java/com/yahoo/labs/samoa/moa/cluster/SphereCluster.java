...
public class SphereCluster extends Cluster {
     ...
     * NOTE: overlapRadiusDegree only calculates the overlap based on the
     * centers and the radi, so not the real overlap
     * 
     ...
     * partly outside of the originating cluster. If a another cluster is right
     * next to the original cluster (without overlapping), the new cluster can
     * be overlapping with this second cluster. OverlapSave will tell you if the
