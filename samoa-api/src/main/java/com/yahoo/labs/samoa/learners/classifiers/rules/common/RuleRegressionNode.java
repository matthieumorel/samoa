...
public abstract class RuleRegressionNode implements Serializable {
    ...
    // {
    // this.perceptron=new Perceptron(((RulePassiveRegressionNode)
    // oldLearningNode).perceptron);
    ...
    // {
    // this.targetMean= new TargetMean(((RuleActiveRegressionNode)
    // oldLearningNode).targetMean);
