...
final class ModelAggregatorProcessor implements Processor {
    ...
    public boolean process(ContentEvent event) {
        ...
        // Poll the blocking queue shared between ModelAggregator and the
        // time-out threads
     ...
     * decision tree, this method routes the incoming instance into the correct
     * leaf and then update the statistic on the found leaf.
     * 
     * @param inst
     */
    ...
    private void attemptToSplit(ActiveLearningNode activeLearningNode, FoundNode foundNode) {
        ...
        this.splittingNodes.put(Long.valueOf(this.splitId), new SplittingNodeInfo(activeLearningNode, foundNode,
                timeOutHandler));
