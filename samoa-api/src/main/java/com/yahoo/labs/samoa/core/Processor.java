...
public interface Processor extends Serializable, Configurable {
     ...
     * is set up and before any call to the {@link process} method.
     * 
     * @param id
     ...
     * */
    Processor newProcessor(Processor processor); // FIXME there should be no
                                                 // need for the processor as a
                                                 // parameter
