...
public class CMM_GTAnalysis {
     ...
     * underlying clustering model (e.g. point being covered by two clusters
    ...
    protected class CMMPoint extends DataPoint {
        ...
        /**
         * Retruns the current working label of the cluster the point belongs
         * to. The label can change due to merging of clusters.
         * 
    ...
    protected class GTCluster {
         ...
         * Connected/overlapping clusters cannot be merged directly because of
         * the underlying cluster model. E.g. for merging two spherical clusters
         * the new cluster sphere can cover a lot more space then two separate
         * smaller spheres. To keep the original coverage we need to keep the
        ...
        /**
         * Calculate the probability of the point being covered through the
         * cluster
         * 
         * @param point
        ...
        private void mergeCluster(int mergeID) {
            if (mergeID < gt0Clusters.size()) {
                ...
                for (int c = 0; c < gt0Clusters.size(); c++) {
                    ...
                    // recalculate connection from other clusters to the new
                    // merged one
    ...
    protected double getConnectionValue(CMMPoint cmmp, int clusterID) {
        ...
        /*
         * calculate the connectivity based on knn distance of the point within
         * the cluster and the upper knn distance of the cluster
         */
        if (avgDist < upperKnn) {
            return 1;
        }
     ...
     * @param knnDist
     *            sorted list of smallest knn distances (can already be filled
     *            to make updates possible)
     * @param knnPointIndex
    ...
    private void getKnnInCluster(CMMPoint cmmp, int k,
        ...
        // iterate over every point in the choosen cluster, cal distance and
        // insert into list
     ...
     * values indicate bad separability, values close to 1 indicate good
     * separability
     * 
