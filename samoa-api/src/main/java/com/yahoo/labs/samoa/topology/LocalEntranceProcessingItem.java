...
public class LocalEntranceProcessingItem extends AbstractEntranceProcessingItem {
     ...
     * no available events, and that the stream is not entirely consumed, it
     * will wait by calling {@link #waitForNewEvents()} before attempting to
     * send again. </p> When the stream is entirely consumed, the last event is
     * tagged accordingly and the processor gets the finished status.
     * 
     */
